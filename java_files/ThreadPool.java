...
{ 
    ...
    public void run()     { 
        try        { 
            for (int i = 0; i<=5; i++)   { 
                if (i==0)  { 
                    System.out.println("Initialization of"
                            + " task name - "+ name +" = " );    
...
{ 
    ...
    public static void main(String[] args)     { 
        ...
        Runnable r5 = new Task("task 5");         Runnable r6 = new Task("task 6");       
        ...
        pool.execute(r1);         pool.execute(r2); 
        pool.execute(r3);         pool.execute(r4); 
        pool.execute(r5);         pool.execute(r6);  
